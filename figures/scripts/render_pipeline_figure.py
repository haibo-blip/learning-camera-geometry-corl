...
def main():
    ...
    sampler = (990, 1452, 1970, 1608)
    rounded(sampler, r=18, fill="white", outline=C_LINE, width=3)
    labeled_tile(view_a, (1044, 1472, 1166, 1586), "source", C_TEAL, label_size=28, image_frac=0.55)
    labeled_tile(ray_a, (1194, 1472, 1332, 1586), "ray", C_TEAL, label_size=28, image_frac=0.55)
    labeled_tile(view_b, (1434, 1472, 1556, 1586), "target", C_RED, label_size=28, image_frac=0.55, overlay_drop=True)
    labeled_tile(ray_b, (1584, 1472, 1722, 1586), "ray", C_RED, label_size=28, image_frac=0.55, overlay_drop=True)
    text_fit_center((1490, 1644), "encoder observations", 34, 620, fill=C_TEXT, bold=True)
    text_fit_center((1490, 1676), "target observation may drop in NVS", 29, 760, fill=C_RED, bold=True)
    arrow([(1108, 1370), (1108, 1452)], color=C_TEAL, width=8)
    arrow([(1835, 1370), (1835, 1452)], color=C_TEAL, width=8)
    ...
    arrow([(1970, 1532), (2060, 1532), (2060, 1270), (2090, 1270)], color=C_TEAL, width=9)
